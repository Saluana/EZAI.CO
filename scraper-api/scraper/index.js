...
app.post("/notes", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var URI, browser, page, error_1, textContent, error_2, content, splitContent, words, i, i, notes, error_3, parsedNotes, removeNewLine, completeNotes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                URI = req.body.URI;
            ...
            case 11:
                ...
                return [4 /*yield*/, Promise.all(splitContent.map(getNote))];
            case 12:
                notes = _a.sent();
                return [3 /*break*/, 14];
            case 13:
...
app.post("/summary", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var URI, browser, page, error_5, textContent, error_6, content, splitContent, words, i, i, summaryList, summaries, error_7, completeSummary;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                URI = req.body.URI;
            ...
            case 11:
                _a.trys.push([11, 13, , 14]);
                return [4 /*yield*/, Promise.all(splitContent.map(getSummary))];
            case 12:
                summaries = _a.sent();
            ...
            case 14:
                ...
                if (completeSummary) {
                    return [2 /*return*/, res.json({ status: "success", message: "Summary created", summary: completeSummary })];
                }
                else {
